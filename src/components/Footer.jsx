...
return (
<footer id="contact" className="border-t border-white/10 mt-8">
...
<a href="#directory" className="hover:text-white">Browse Directory</a>
<a href="#how" className="hover:text-white">How It Works</a>
<a href="https://smithdigitals.com/#/contact" target="_blank" rel="noopener" className="hover:text-white">List Your Business</a>
</div>
</div>
<div>
<h3 className="font-semibold text-white mb-2">Contact</h3>
<div className="flex flex-col gap-2 text-sm text-white/70">
<a href="mailto:dylanjsmith.dev@gmail.com" className="hover:text-white">dylanjsmith.dev@gmail.com</a>
<a href="tel:+14239231909" className="hover:text-white">(423) 923-1909</a>
